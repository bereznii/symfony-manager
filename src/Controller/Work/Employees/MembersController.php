...
use App\Model\Work\UseCase\Employees\Member\Archive;
use App\Model\Work\UseCase\Employees\Member\Edit;
use App\Model\Work\UseCase\Employees\Member\Reinstate;
use App\Model\Work\UseCase\Employees\Member\Create;
use App\Model\Work\UseCase\Employees\Member\Move;
use App\ReadModel\Work\Employees\Member\Filter;
...
#[Route(path: '/work/employees/members', name: 'work.employees.members')]
...
class MembersController extends AbstractController
{
    ...
    public function index(Request $request, MemberFetcher $fetcher): Response
    {
        ...
        return $this->render('app/work/employees/members/index.html.twig', [
    ...
    public function create(User $user, Request $request, MemberFetcher $members, Create\Handler $handler): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            try {
                ...
                return $this->redirectToRoute('work.employees.members.show', ['id' => $user->getId()]);
        ...
        return $this->render('app/work/employees/members/create.html.twig', [
            'form' => $form->createView(),
        ]);
    }
    ...
    public function edit(Member $member, Request $request, Edit\Handler $handler): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            try {
                $handler->handle($command);
                return $this->redirectToRoute('work.employees.members.show', ['id' => $member->getId()]);
            } catch (\DomainException $e) {
                $this->logger->warning($e->getMessage(), ['exception' => $e]);
                $this->addFlash('error', $e->getMessage());
            }
        ...
        return $this->render('app/work/employees/members/edit.html.twig', [
            'member' => $member,
            'form' => $form->createView(),
        ]);
    }
    ...
    public function move(Member $member, Request $request, Move\Handler $handler): Response
    {
        ...
        return $this->render('app/work/employees/members/move.html.twig', [
            'member' => $member,
            'form' => $form->createView(),
        ]);
    }
    ...
    {
        return $this->render('app/work/employees/members/show.html.twig', compact('member'));
    }
}