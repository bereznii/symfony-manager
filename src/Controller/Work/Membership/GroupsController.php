...
use App\Model\Work\UseCase\Membership\Group\Create;
use App\Model\Work\UseCase\Membership\Group\Edit;
use App\Model\Work\UseCase\Membership\Group\Remove;
...
class GroupsController extends AbstractController
{
    ...
    public function index(GroupFetcher $fetcher): Response
    {
        ...
        return $this->render('app/work/membership/groups/index.html.twig', compact('groups'));
    }
    ...
    public function create(Request $request, Create\Handler $handler): Response
    {
        ...
        return $this->render('app/work/membership/groups/create.html.twig', [
    ...
    public function edit(Group $group, Request $request, Edit\Handler $handler): Response
    {
        ...
        return $this->render('app/work/membership/groups/edit.html.twig', [
            'group' => $group,
            'form' => $form->createView(),
        ]);
    }
